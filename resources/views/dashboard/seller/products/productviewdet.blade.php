            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <ul class="nav nav-tabs card-header-tabs" id="prodict-detail-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="btn btn-outline-primary nav-link" href="#productdetails" role="tab"
                                     aria-controls="productdetails" aria-selected="true">Specifications</a>
                            </li>
                            <li class="nav-item">
                                <a class="btn btn-outline-primary nav-link"  href="#productstocks" role="tab"
                                    aria-controls="productstocks" aria-selected="false">Stocks</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content mt-5">
                                    ...
                                    <tbody>
                                        @foreach ($attributes as $key=>$attr)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $get_arr = explode(',',$attr);
                                                    @endphp
                                                    @foreach ($get_arr as $val)
                                                        <p><span class="badge badge-outline-success">{{ strtoupper($val) }}</span></p>
                                                    @endforeach
                                                </td>
                                            </tr>
                                            @endif
                        ...
                        {{-- My Product Reviews--}}
                        <div class="tab-pane" id="productstocks" role="tabpanel">
                                        ...
                                        @foreach ($product_stocks as $stock)
                                            <tr>
                                                <td>
                                                    ...
                                                    @else
                                                    <span class="badge badge-pill badge-standard">Custom</span>
                                                    @endif
                                                </td>

...
<body
    ...
    <span class="preheader"
        style="color: transparent; display: none; font-size: 1px; height: 0; opacity: 0; visibility: hidden; width: 0;">Bazaart Email Verification.</span>
    <table
                                                    ...
                                                    <table class="p100"
                                                        ...
                                                        <tr>
                                                            <td style="color: #000000; font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; line-height: 23px; mso-line-height-rule: exactly;"
                                                                ...
                                                                <font face="'Roboto', sans-serif">Please click the
                                                                    button below to Reset Your Password</font>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="height: 20px; line-height: 20px; font-size: 1px; mso-line-height-rule: exactly;"
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;background-color: #ef814c; color: #ffffff; font-family: 'Roboto', sans-serif; font-weight: 700; line-height: 100%; mso-line-height-rule: exactly; padding: 11px 20px; vertical-align: middle;"
                                                                                                align="center"
                                                                                                valign="top">
                                                                                                <a href="{{url('/')}}/ResetEmail?email={{$data['enc_mail']}}&token={{ $data['token'] }}&usertype={{ $data['usertype'] }}"
                                                                                                    target="_blank"
                                                                                                    style="border: none; color: #ffffff; display: block; font-family: 'Roboto', sans-serif; font-size: inherit; font-weight: 700; outline: none; text-decoration: none;">Reset
                                                                                                    Email</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
